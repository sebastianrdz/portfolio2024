...
export default function AboutPage() {
  ...
  const textBoxClassName =
    "grid bg-primary-foreground w-fill min-h-[500px] h-fill content-center justify-center p-8 xl:p-32";

  const imageBoxClassName =
    "grid bg-primary-foreground w-fill min-h-[500px] h-fill content-center justify-center relative";
  ...
  return (
    <section id="about" className="container mx-auto mt-32 my-8">
      <div className="grid grid-cols-1 md:grid-cols-2">
        ...
        <div className={cn(textBoxClassName, " bg-white")}>
          <Icons.tec className="aspect-square w-80 h-80 p-4 text-blue-900 dark:text-secondary" />
        </div>
      </div>
